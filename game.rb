card_details = [{ace_of_spades: {numeric_value: 1, value: 11}},
                ...
                {ace_of_clubs: {numeric_value: 27, value: 11}},
                {king_of_clubs: {numeric_value: 28, value: 10}},
                {queen_of_clubs: {numeric_value: 29, value: 10}},
                {jack_of_clubs: {numeric_value: 30, value: 10}},
                {clubs_10: {numeric_value: 31, value: 10}},
                {clubs_9: {numeric_value: 32, value: 9}},
                {clubs_8: {numeric_value: 33, value: 8}},
                {clubs_7: {numeric_value: 34, value: 7}},
                {clubs_6: {numeric_value: 35, value: 6}},
                {clubs_5: {numeric_value: 36, value: 5}},
                {clubs_4: {numeric_value: 37, value: 4}},
                {clubs_3: {numeric_value: 38, value: 3}},
                {clubs_2: {numeric_value: 39, value: 2}},
                {ace_of_hearts: {numeric_value: 40, value: 11}},
                {king_of_hearts: {numeric_value: 41, value: 10}},
                {queen_of_hearts: {numeric_value: 42, value: 10}},
                {jack_of_hearts: {numeric_value: 43, value: 10}},
                {hearts_10: {numeric_value: 44, value: 10}},
                {hearts_9: {numeric_value: 45, value: 9}},
                {hearts_8: {numeric_value: 46, value: 8}},
                {hearts_7: {numeric_value: 47, value: 7}},
                {hearts_6: {numeric_value: 48, value: 6}},
                {hearts_5: {numeric_value: 49, value: 5}},
                {hearts_4: {numeric_value: 50, value: 4}},
                {hearts_3: {numeric_value: 51, value: 3}},
                {hearts_2: {numeric_value: 52, value: 2}}]

def get_card_value(card_details, card)
  #take hash, numeric_value then return value
